...
class DiMP(BaseTracker):
    ...
    def track(self, image, info: dict = None) -> dict:
        ...
        scores_raw2=self.final_conves(scores_raw)
        
        
        

        # Localize the target
        translation_vec, scale_ind, s, flag = self.localize_target(scores_raw2, sample_pos, sample_scales)
    ...
    def classify_target(self, sample_x: TensorList):
        ...
        return scores
    def final_conves(self,scores_raw):
        scores_raw=self.net.final_conves(scores_raw)
        return scores_raw
    ...
    def generate_init_samples(self, im: torch.Tensor) -> TensorList:
        ...
        with torch.no_grad():
            init_backbone_feat,skipInfo = self.net.extract_backbone(im_patches)
