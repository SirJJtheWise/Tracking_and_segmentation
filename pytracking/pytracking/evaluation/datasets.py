...
dataset_dict = dict(
    ...
    seg=DatasetInfo(module=pt % "seg", class_name="SegDataset", kwargs=dict()),
    vessel=DatasetInfo(module=pt % "vessel", class_name="VesselDataset", kwargs=dict()),
    vessel_train=DatasetInfo(module=pt % "vessel", class_name="VesselTrainDataset", kwargs=dict()),
    vessel_val=DatasetInfo(module=pt % "got10k", class_name="VesselDataset", kwargs=dict(split='val', vos_mode=True)),
)
