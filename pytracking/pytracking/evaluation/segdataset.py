...
class SegDataset(BaseDataset):
    ...
    def __init__(self, attribute=None):
        super().__init__()
        self.base_path = self.env_settings.seg_path
    ...
    def _construct_sequence(self, sequence_info):
        ...
        return Sequence(sequence_info['name'], frames, 'seg', ground_truth_rect[init_omit:,:],
    ...
    def _load_attributes(self):
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)),
                               'dataset_attribute_specs', 'seg_attributes.json'), 'r') as f:
    ...
    def _get_sequence_info_list(self):
        ...
        sequence_info_list = [
            {"name": "Plaque_0001", "path": "data_seq/Plaque_0001", "startFrame": 1, "endFrame": 96, "nz": 6,
             "ext": "png", "anno_path": "anno/Plaque_0001.txt", "object_class": "vehicle"},
            {"name": "Plaque_0002", "path": "data_seq/Plaque_0002", "startFrame": 1, "endFrame": 193, "nz": 6,
             "ext": "png", "anno_path": "anno/Plaque_0002.txt", "object_class": "vehicle"},
            {"name": "Plaque_0003", "path": "data_seq/Plaque_0003", "startFrame": 1, "endFrame": 251, "nz": 6,
             "ext": "png", "anno_path": "anno/Plaque_0003.txt", "object_class": "vehicle"}]

        return sequence_info_list

class SegTrainDataset(SegDataset):
    def __init__(self):
        super().__init__()
