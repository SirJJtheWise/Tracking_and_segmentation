...
class LinearFilter(nn.Module):
    ...
    def forward(self, train_feat, test_feat, train_bb, *args, **kwargs):
        ...
        #we want to reduce filter size to increase dim of the score maps
        #train_feat=train_feat.view(6,512,18,18)
        #train_feat=self.conv1(train_feat)
        #train_feat=train_feat.view(3, 2, 256, 18, 18)
        # Train filter
    ...
    def classify(self, weights, feat):
        ...
        scores = filter_layer.apply_filter_end(feat, weights)
